...
<link href="/resources/css/delivery/menu.css" rel="stylesheet" type="text/css">

<%-- js --%>
<script src="/resources/js/delivery/menu.js" type="text/javascript"></script>
<%-- forEach --%>
	...
	<div class="box">
		<div class="header">
			<div class="content_w">
				<div class="header_top">
					<input class="header_top_btn fs_14" type="button" onclick="location.href='/?m_number=${sessionScope.loginNumber}'" value="브랜드홈" />
		...
		<div class="contents_box">
			...
			<div class="location_box">
				<div class="content_w">
					<p class="location_txt dis_inblock fs_15">딜리버리 &gt; 메뉴</p>
			...
			<%-- delivery menu title --%>
			<div class="delivery_menu_top_box">
				<div class="content_w">
					<p class="delivery_menu_top_title dis_inblock fs_40">메뉴</p>
					
					<%-- admin --%>
					<c:if test="${sessionScope.loginId eq 'admin'}">
						<input class="admin_menu_product_btn" type="button" value="수정" onclick="location.href='/admin/product/updateForm'" />
						<input class="admin_menu_product_btn" type="button" value="추가" onclick="location.href='/admin/product/saveForm'" />
					</c:if>
					<%-- admin --%>
					
					<div class="delivery_menu_title_box ">
						<input class="delivery_menu delivery_menu_default" id="menu-title-1" type="button" value="스페셜 &amp; 할인팩" />
						<input class="delivery_menu" id="menu-2-title" type="button" value="프리미엄" />
						<input class="delivery_menu" id="menu-3-title" type="button" value="와퍼" />
						<input class="delivery_menu" id="menu-4-title" type="button" value="주니어 &amp; 버거" />
						<input class="delivery_menu" id="menu-5-title" type="button" value="치킨버거" />
						<input class="delivery_menu" id="menu-6-title" type="button" value="사이드" />
						<input class="delivery_menu" id="menu-7-title" type="button" value="음료 &amp; 디저트" />
						<input class="delivery_menu" id="menu-8-title" type="button" value="독퍼" />
					</div>
				</div>
			</div>
			<%-- delivery menu title --%>
			...
			<%-- delivery menu 1 box --%>
			<div class="delivery_menu_table_box">
				<div class="content_w">
					<%-- <c:forEach items="${productList}" var="product"> --%>
					<table class="delivery_menu_table">
						<tbody>
							<tr><td>${product.p_number}</td></tr>
							<tr>
								<td><img class="delivery_menu_table_img" src="/resources/img/product/${product.p_filename}" /></td>
							</tr>
							<tr>
								<td class="delivery_menu_table_name">${product.p_name}</td>
							</tr>
							<tr>
								<td class="delivery_menu_table_price">${product.p_price}</td>
							</tr>
						</tbody>
					</table>
					<%-- </c:forEach> --%>
