	...
	<div class="box">
		...
		<div class="contents_box">
			...
			<div class="location_box">
				<div class="content_w">
					<p class="location_txt fs_14">Admin &gt; 공지사항</p>
				</div>
			</div>
			<%-- location --%>
			
			<%-- admin notice save --%>
			<form class="admin_notice_box" action="/admin/notice/save" method="POST" enctype="multipart/form-data">
				<div class="admin_content_w">
					<p class="admin_title">메뉴추가</p>
					<input class="admin_input_txt" type="text" name="n_title" placeholder="제목" />
					<input class="admin_input_txt" type="text" name="n_contents" placeholder="내용" />
					<input class="admin_input_file" type="file" name="n_file" />
